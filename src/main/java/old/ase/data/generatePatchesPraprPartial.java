 ...
 * @author Sam Benton
 */
public class generatePatchesPraprPartial {

    public static void main(String args[]) throws IOException {

        for (File ff : (new File("C:\\Users\\prodi\\Downloads\\patch_location_partial.tar\\patch_location_partial").listFiles())) {
            for (File f : ff.listFiles()) {
                String[] variants = {"proflvariant-partial-standard", "proflvariant-partial-extended"};
